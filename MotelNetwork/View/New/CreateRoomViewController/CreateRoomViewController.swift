            ...
            if renterName.isEmpty {
                ...
                for image in imageArray {
                    self.uploadImage(image: image) { (url) -> (Void) in
                        ...
                        for url in self.urlArray {
                            let values = ["roomName": roomName, "area": area, "price": priceDouble ?? 0.0, "ownerID": ownerID, "roomImageUrl\(self.urlArray.index(of: url) ?? 0)": url, "usersAllowed": usersAllowed, "address": address, "renterName": "", "renterID": "", "id": roomID] as [String: AnyObject]
                ...
                for image in self.imageArray {
                    self.uploadImage(image: image) { (url) -> (Void) in
                        ...
                        for url in self.urlArray {
                            let values = ["roomImageUrl\(self.urlArray.index(of: url) ?? 0)": url, "roomName": roomName, "area": area, "price": priceDouble ?? 0.0, "ownerID": ownerID, "usersAllowed": usersAllowed, "address": address, "renterName": renterName, "id": roomID] as [String: AnyObject]
